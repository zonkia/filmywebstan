...
class DodatkoweInfo(models.Model):  # one to one
    GATUNEK = {
        (0, "Inny"),
        (1, "Horror"),
        (2, "Komedia"),
...
class Film(models.Model):
    ...
    # cascade usuwa dodatkowe info
    dodatkowe = models.OneToOneField(
        DodatkoweInfo, on_delete=models.CASCADE, null=True, blank=True)
